...
<?php
	if($image!=null){
		echo "<form action='' method='POST'
			...
			<input type='submit' name='dsubmit' class = 'button' style='width: 100px;  background-color: rgb(47, 93, 193); padding: 6px; font-size: 100%; margin-bottom:0; ' value='Delete It' > or 
			<input type='submit' class='button' name='button1' style='width: 180px; background-color: rgb(47, 93, 193);  padding: 6px; font-size: 100%;' value='Done, Go to Shop'/></h3>
	</form>";
}
	if($image==null){
		echo "<form action='file_upload.php' class='upload-form' method='POST'
			...
			(Max-size 2MB)
			<input type='submit' class='button' style='width: 100px; background-color: rgb(40, 91, 203); padding: 4px; font-size: 110%;' name='submit' value=
			'Upload'/>
