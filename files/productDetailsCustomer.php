...
<body>
	...
	<form action="shopDetailsCustomer.php" method="POST"  style=' all:revert;  text-align: right;'>
			...
			<input type="submit"  class="button"  value="Back"  style="background-color:  rgb(40, 91, 203); width: 80px; height: 32px; padding: 0; text-align: center; margin:1px; font-size: 100%;">
