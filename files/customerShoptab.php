...
<body>
  ...
  <div class="site-pusher">
    ...
    <header class="header" style="  background-color: rgb(40, 91, 203);">
...
?>
	<div style=" background-image: url('<?php echo $image; ?>'); background-size: 100% 100%; background-repeat: no-repeat;"  class="product">
		...
		<form action='shopDetailsCustomer.php' method='POST'
			...
			<input class="mybutton nonClick" style="margin-top: 216px; padding: 7px; font-size: 110%;  background-color: rgb(47, 93, 193);" type='submit' name='' value="<?php echo $row['shopName']; ?>" />
			<input class="mybutton nonClick" style=" margin-top: 216px; float: right;  padding: 7px; font-size: 110%; background-color: rgb(47, 93, 193);" type='submit' name='' value="<?php echo $row['shopCategory']; ?>" />
			<input  type='submit'  class="mybutton" style=" margin-top: 6px; float: right;  padding: 7px; font-size: 110%; background-color: rgb(47, 93, 193);" name='proDelete' value='Go To Shop'  />
