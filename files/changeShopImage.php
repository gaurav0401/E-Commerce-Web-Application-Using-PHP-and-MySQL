...
<?php
	if($image!=null){
		echo "<form action='' method='POST'
			...
			<input type='submit' name='dsubmit' class = 'button' style='width: 100px;  padding: 6px; font-size: 100%; margin-bottom:0; background-color: rgb(47, 93, 193);' value='Delete It' > or 
	...
	if($image==null){
		echo "<form action='file_upload.php' method='POST'
			...
			<input type='submit' class='button' style='width: 100px; background-color: rgb(47, 93, 193); padding: 4px; font-size: 110%;' name='submit' value=
			'Upload'/>
