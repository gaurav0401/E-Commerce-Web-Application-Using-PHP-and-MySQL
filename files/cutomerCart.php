  ...
  <div class="site-pusher">
	...
	<?php 
		...
		if($rowit['totalItems']!=0){
			...
			echo" >
			<span ><input type='submit' value='Check Out' name='CheckOut' class='mybutton' style='height: 35px; background-color: rgb(40, 91, 203);'></span>
...
?>
	<div style=" background-image: url('<?php echo $image; ?>'); background-size: 100% 100%; background-repeat: no-repeat;"  class="product myDiv">
		...
		<form action='productOperCustomer.php' method='POST'
			...
			<input class="addstyle nonClick" style="margin-top: 236px; background-color: rgb(40, 91, 203);" type='submit' name='' value="Rs : <?php echo $row1['price']; ?>" />
			<input   type='submit' style="background-color: rgb(40, 91, 203);" class="addstyle" name='proD' value='Details' />
			<!-- <input  type='submit' class="addstyle" name='addC' value='Add to Cart' /> -->
			<input  type='submit' style="background-color: rgb(40, 91, 203);" class="addstyle" name='rem' value='Remove' />
		</p>
	</form>
