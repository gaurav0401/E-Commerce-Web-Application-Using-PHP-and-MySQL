...
?>
	<div style=" background-image: url('<?php echo $image; ?>'); background-size: 100% 100%; background-repeat: no-repeat;"  class="product">
		...
		<form action='productOperCustomer.php' method='POST'
			...
			<input  class="addstyle nonClick" style="margin-top: 236px; background-color: rgb(47, 93, 193);" type='submit' name=''  value="Rs : <?php echo $row['price']; ?>"   />
			<input  type='submit' class="addstyle" name='proD' value='Details' style=" background-color: rgb(47, 93, 193);"  />
			<input  type='submit' class="addstyle" name='addC' value='Add to Cart'  style=" background-color: rgb(47, 93, 193);" />
		</p>
	</form>
