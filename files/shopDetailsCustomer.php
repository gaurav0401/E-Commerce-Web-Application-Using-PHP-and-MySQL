...
<body>
	...
	<form action='shopCusback_bad.php' method='POST'
			...
			<input type='submit' class="button" name='back' value='Back' style="background-color:  rgb(40, 91, 203); width: 80px; height: 32px; padding: 0; text-align: center; margin:1px; font-size: 100%;" onclick="history.back()" />
		</p>
	</form>
...
?>
	...
	height: 100%; margin-top: 10px; background-repeat: no-repeat;"  class="product">
		...
		<form action='productOperCustomer.php' method='POST'
			...
			<input class="addstyle nonClick" style="background-color:  rgb(40, 91, 203); margin-top: 236px; width: 90px; height: 32px; padding: 0; text-align: center;  font-size: 100%;" type='submit' name='' value="Rs : <?php echo $row['price']; ?>" />
			<input  type='submit' class="addstyle" style="background-color:  rgb(40, 91, 203); width: 90px; height: 32px; padding: 0; text-align: center; margin:1px; font-size: 100%;" name='proD' value='Details' />
			<input  type='submit' class="addstyle" style="background-color:  rgb(40, 91, 203); width: 90px; height: 32px; padding: 0; text-align: center; margin:1px; font-size: 100%;" name='addC' value='Add to Cart' />
		</p>
	</form>
