...
<body>
		...
		<form action='sellerDashnavi.php' method='POST'
			...
			<p>
			<input type='submit' name='Psubmit' class="button" value='Go To Dashboard' style="width: 170px; height: 32px; padding: 0; text-align: center; margin:1px; font-size: 100%; background-color: rgb(47, 93, 193);" />
		</p>
	</form>
