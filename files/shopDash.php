...
?>
	<div   class="product" style=" background-image: url('<?php echo $image; ?>'); background-size: 100% 100%; background-repeat: no-repeat;">
		...
		<form action='productOper.php' method='POST'
			...
			<input class="addstyle nonClick" style="margin-top: 196px; background-color: rgb(47, 93, 193);" type='submit'  name='' value=" Pid : <?php echo $row['pid']; ?>" />
			<input class="addstyle nonClick" style="margin-top: 196px; background-color: rgb(47, 93, 193);" type='submit' name='' value="Rs : <?php echo $row['price']; ?>" />
			<br>
			<input  type='submit' class="addstyle" style="background-color: rgb(47, 93, 193);" name='proDelete' value='Delete' />
			<input  type='submit' class="addstyle" style="background-color: rgb(47, 93, 193);" name='proDetail' value='Details' />
		</p>
	</form>
