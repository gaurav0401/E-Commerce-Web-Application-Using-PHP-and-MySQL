...
<div class="site-container">
  <div class="site-pusher">
    ...
    <header class="header" style="  background-color: rgb(40, 91, 203);">
      ...
      <nav class="menu">
        ...
        <div class="formNav">
			...
			<input class="simpleButton" type='submit' name='Asubmit' value='Add Shop' style="" />
	...
	<input type="submit" name="submit" value ="Add" class="button"style="background-color: rgb(47, 93, 193); padding: 8px; width: 90%;
  font-size: 125%;
