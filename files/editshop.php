...
<div class="site-container">
  <div class="site-pusher">
	...
	<input type="submit" name="submit" value ="Done" class="button"style=" background-color: rgb(47, 93, 193); padding: 6px; width: 47%;
  font-size: 125%;
  margin-bottom: 18px;">
  <input type="submit" name="editImg" value ="Edit Image" class="button"style="background-color: rgb(47, 93, 193); padding: 6px; width: 47%;
  font-size: 125%;
